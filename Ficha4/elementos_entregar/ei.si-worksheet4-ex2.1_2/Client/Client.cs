    ...
    class Client
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                {
                    rsaClient.FromXmlString(File.ReadAllText("client.txt"));
                }
                else 
                {
                    File.WriteAllText("client.txt", rsaClient.ToXmlString(true));
                }

                File.WriteAllText("client.xml", rsaClient.ToXmlString(true));
