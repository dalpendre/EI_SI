    ...
    class ClientWithProtocolSI
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                Console.Write("Sending  data... ");
                byte[] signature = rsaClient.SignData(encryptedData, hashAlgorithm);
                ...
                {
                    Console.WriteLine("ok - Server validated signature");
                }
                else 
                {
                    Console.WriteLine("NOT ok - Server could not validate signature");
                }
